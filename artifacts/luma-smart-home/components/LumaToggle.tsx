...
export default function LumaToggle({ value, onToggle, disabled, size = "md", label, accessibilityLabel }: LumaToggleProps) {
  ...
  const toggleLabel = accessibilityLabel || label || "Toggle switch";
